...
describe('Pronounce Management Component', () => {
  let comp: PronounceComponent;
  let fixture: ComponentFixture<PronounceComponent>;
  let service: PronounceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pronounce', component: PronounceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PronounceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pronounces?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
