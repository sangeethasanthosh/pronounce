class GetResModel {
  int status;
  String msg;
  List<Restaurants1> restaurants;

  GetResModel({this.status, this.msg, this.restaurants});

  GetResModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['restaurants'] != null) {
      restaurants = new List<Restaurants1>();
      json['restaurants'].forEach((v) {
        restaurants.add(new Restaurants1.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.restaurants != null) {
      data['restaurants1'] = this.restaurants.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Restaurants1 {
  ...
  Restaurants1.fromJson(Map<String, dynamic> json) {
    resId = json['res_id'];
    catId = json['cat_id'];
