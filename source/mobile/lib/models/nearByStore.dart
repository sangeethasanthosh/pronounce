class NearByStores {
  int status;
  String msg;
  List<RestaurantsN> restaurants;

  NearByStores({this.status, this.msg, this.restaurants});

  NearByStores.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['restaurants'] != null) {
      restaurants = new List<RestaurantsN>();
      json['restaurants'].forEach((v) {
        restaurants.add(new RestaurantsN.fromJson(v));
      });
    }
  }
...
class RestaurantsN {
  ...
  RestaurantsN.fromJson(Map<String, dynamic> json) {
    resId = json['res_id'];
    catId = json['cat_id'];
